...
class Envira_Gallery_Posttype {
	...
	public function __construct() {
		...
		$labels = array(
			'name'               => __( 'Galleries', 'envira-gallery-lite - Copy' ),
			'singular_name'      => __( 'Gallery', 'envira-gallery-lite - Copy' ),
			'add_new'            => __( 'Add New', 'envira-gallery-lite - Copy' ),
			'add_new_item'       => __( 'Add New Gallery', 'envira-gallery-lite - Copy' ),
			'edit_item'          => __( 'Edit Gallery', 'envira-gallery-lite - Copy' ),
			'new_item'           => __( 'New Gallery', 'envira-gallery-lite - Copy' ),
			'view_item'          => __( 'View Gallery', 'envira-gallery-lite - Copy' ),
			'search_items'       => __( 'Search Galleries', 'envira-gallery-lite - Copy' ),
			'not_found'          => __( 'No galleries found.', 'envira-gallery-lite - Copy' ),
			'not_found_in_trash' => __( 'No galleries found in trash.', 'envira-gallery-lite - Copy' ),
			'parent_item_colon'  => '',
			'menu_name'          => __( 'Envira Gallery', 'envira-gallery-lite - Copy' ),
		);
