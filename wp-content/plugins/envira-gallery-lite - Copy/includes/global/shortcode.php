					...
					if ( $this->get_config( 'lightbox_enabled', $data ) ) {
						...
						envira_gallery_options = {
							...
							tpl: {
								...
								error    : '<p class="envirabox-error"><?php echo esc_attr__( 'The requested content cannot be loaded.<br/>Please try again later.</p>', 'envira-gallery-lite - Copy' ); ?>',
								closeBtn : '<a title="<?php echo esc_attr__( 'Close', 'envira-gallery-lite - Copy' ); ?>" class="envirabox-item envirabox-close" href="#"></a>',
								next     : '<a title="<?php echo esc_attr__( 'Next', 'envira-gallery-lite - Copy' ); ?>" class="envirabox-nav envirabox-next envirabox-arrows-<?php echo esc_attr( $this->get_config( 'arrows_position', $data ) ); ?>" href="#"><span></span></a>',
								prev     : '<a title="<?php echo esc_attr__( 'Previous', 'envira-gallery-lite - Copy' ); ?>" class="envirabox-nav envirabox-prev envirabox-arrows-<?php echo esc_attr( $this->get_config( 'arrows_position', $data ) ); ?>" href="#"><span></span></a>'
	...
	public function get_toolbar_template( $data ) {
		...
		$template         = '<div id="envirabox-buttons">';
			$template    .= '<ul>';
				...
				// Prev.
				$template .= '<li><a class="btnPrev" title="' . __( 'Previous', 'envira-gallery-lite - Copy' ) . '" href="javascript:;"></a></li>';
				$template  = apply_filters( 'envira_gallery_toolbar_after_prev', $template, $data );

				// Next.
				$template .= '<li><a class="btnNext" title="' . __( 'Next', 'envira-gallery-lite - Copy' ) . '" href="javascript:;"></a></li>';
		...
		if ( $this->get_config( 'toolbar_title', $data ) ) {
			...
			$template  = apply_filters( 'envira_gallery_toolbar_after_title', $template, $data );
				...
				// Close.
				$template .= '<li><a class="btnClose" title="' . __( 'Close', 'envira-gallery-lite - Copy' ) . '" href="javascript:;"></a></li>';
