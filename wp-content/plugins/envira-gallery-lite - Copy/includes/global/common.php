...
class Envira_Gallery_Common {
	...
	public function get_columns() {
		...
		$columns = array(
			array(
				'value' => '0',
				'name'  => __( 'Automatic', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '1',
				'name'  => __( 'One Column (1)', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '2',
				'name'  => __( 'Two Columns (2)', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '3',
				'name'  => __( 'Three Columns (3)', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '4',
				'name'  => __( 'Four Columns (4)', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '5',
				'name'  => __( 'Five Columns (5)', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '6',
				'name'  => __( 'Six Columns (6)', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function get_gallery_themes() {
		...
		$themes = array(
			array(
				'value' => 'base',
				'name'  => __( 'Base', 'envira-gallery-lite - Copy' ),
				'file'  => $this->base->file,
			),
		);
	...
	public function get_justified_gallery_themes() {
		...
		$themes = array(
			array(
				'value' => 'normal',
				'name'  => __( 'Normal', 'envira-gallery-lite - Copy' ),
				'file'  => $this->base->file,
			),
		);
	...
	public function get_display_description_options() {
		...
		$descriptions = array(
			array(
				'name'  => __( 'Do not display', 'envira-gallery-lite - Copy' ),
				'value' => 0,
			),
			array(
				'name'  => __( 'Display above galleries', 'envira-gallery-lite - Copy' ),
				'value' => 'above',
			),
			array(
				'name'  => __( 'Display below galleries', 'envira-gallery-lite - Copy' ),
				'value' => 'below',
			),
		);
	...
	public function get_sorting_options() {
		...
		$options = array(
			array(
				'name'  => __( 'No Sorting', 'envira-gallery-lite - Copy' ),
				'value' => 0,
			),
			array(
				'name'  => __( 'Random', 'envira-gallery-lite - Copy' ),
				'value' => 1, // Deliberate, as we map the 'random' config key which was a true/false.
			),
			array(
				'name'  => __( 'Published Date', 'envira-gallery-lite - Copy' ),
				'value' => 'date',
			),
			array(
				'name'  => __( 'Filename', 'envira-gallery-lite - Copy' ),
				'value' => 'src',
			),
			array(
				'name'  => __( 'Title', 'envira-gallery-lite - Copy' ),
				'value' => 'title',
			),
			array(
				'name'  => __( 'Caption', 'envira-gallery-lite - Copy' ),
				'value' => 'caption',
			),
			array(
				'name'  => __( 'Alt', 'envira-gallery-lite - Copy' ),
				'value' => 'alt',
			),
			array(
				'name'  => __( 'URL', 'envira-gallery-lite - Copy' ),
				'value' => 'link',
			),
		);
	...
	public function get_sorting_directions() {
		...
		$directions = array(
			array(
				'name'  => __( 'Ascending (A-Z)', 'envira-gallery-lite - Copy' ),
				'value' => 'ASC',
			),
			array(
				'name'  => __( 'Descending (Z-A)', 'envira-gallery-lite - Copy' ),
				'value' => 'DESC',
			),
		);
	...
	public function get_lightbox_themes() {
		...
		$themes = array(
			array(
				'value' => 'base',
				'name'  => __( 'Legacy', 'envira-gallery-lite - Copy' ),
				'file'  => $this->base->file,
			),
		);
	...
	public function get_image_sizes( $wordpress_only = false ) {
		...
		if ( ! $wordpress_only ) {
			$sizes = array(
				array(
					'value' => 'default',
					'name'  => __( 'Default', 'envira-gallery-lite - Copy' ),
				),
			);
		}
	...
	public function get_title_displays() {
		...
		$displays = array(
			array(
				'value' => 'float',
				'name'  => __( 'Float', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'float_wrap',
				'name'  => __( 'Float (Wrapped)', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'inside',
				'name'  => __( 'Inside', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'outside',
				'name'  => __( 'Outside', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'over',
				'name'  => __( 'Over', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function get_transition_effects() {
		...
		$effects = array(
			array(
				'value' => 'none',
				'name'  => __( 'No Effect', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'fade',
				'name'  => __( 'Fade', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'elastic',
				'name'  => __( 'Elastic', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function get_easing_transition_effects() {
		...
		$effects = array(
			array(
				'value' => 'Swing',
				'name'  => __( 'Swing', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function get_toolbar_positions() {
		...
		$positions = array(
			array(
				'value' => 'top',
				'name'  => __( 'Top', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'bottom',
				'name'  => __( 'Bottom', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function get_supported_filetypes() {
		...
		$supported_file_types = array(
			array(
				'title'      => __( 'Image Files', 'envira-gallery-lite - Copy' ),
	...
	public function get_media_positions() {
		...
		$positions = array(
			array(
				'value' => 'before',
				'name'  => __( 'Before Existing Images', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => 'after',
				'name'  => __( 'After Existing Images', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function get_media_delete_options() {
		...
		$options = array(
			array(
				'value' => '',
				'name'  => __( 'No', 'envira-gallery-lite - Copy' ),
			),
			array(
				'value' => '1',
				'name'  => __( 'Yes', 'envira-gallery-lite - Copy' ),
			),
		);
	...
	public function resize_image( $url, $width = null, $height = null, $crop = true, $align = 'c', $quality = 100, $retina = false, $data = array(), $force_overwrite = false ) {
		...
		if ( ! file_exists( $dest_file_name ) || ( file_exists( $dest_file_name ) && $force_overwrite ) ) {
			...
			if ( is_wp_error( $editor ) ) {
				return new WP_Error( 'envira-gallery-error-no-editor', __( 'No image editor could be selected. Please verify with your webhost that you have either the GD or Imagick image library compiled with your PHP install on your server.', 'envira-gallery-lite - Copy' ) );
			}
	...
	public function get_image_info( $args ) {
		...
		if ( empty( $url ) ) {
			return new WP_Error( 'envira-gallery-error-no-url', __( 'No image URL specified for cropping.', 'envira-gallery-lite - Copy' ) );
		}
		...
		if ( ! file_exists( $file_path ) ) {
			return new WP_Error( 'envira-gallery-error-no-file', __( 'No file could be found for the image URL specified.', 'envira-gallery-lite - Copy' ) );
		}
		...
		if ( ! $size ) {
			return new WP_Error( 'envira-gallery-error-no-size', __( 'The dimensions of the original image could not be retrieved for cropping.', 'envira-gallery-lite - Copy' ) );
		}
	 ...
	 */
	public function get_transient_expiration_time( $plugin = 'envira-gallery-lite - Copy' ) {
