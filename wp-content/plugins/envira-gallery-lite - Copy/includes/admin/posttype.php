...
class Envira_Gallery_Posttype_Admin {
	...
	public function messages( $messages ) {
		...
		$envira_messages    = array(
			0  => '',
			1  => __( 'Envira gallery updated.', 'envira-gallery-lite - Copy' ),
			2  => __( 'Envira gallery custom field updated.', 'envira-gallery-lite - Copy' ),
			3  => __( 'Envira gallery custom field deleted.', 'envira-gallery-lite - Copy' ),
			4  => __( 'Envira gallery updated.', 'envira-gallery-lite - Copy' ),
			/* translators: %s: revision version */
			5  => isset( $_GET['revision'] ) ? sprintf( __( 'Envira gallery restored to revision from %s.', 'envira-gallery-lite - Copy' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false, // @codingStandardsIgnoreLine
			6  => __( 'Envira gallery published.', 'envira-gallery-lite - Copy' ),
			7  => __( 'Envira gallery saved.', 'envira-gallery-lite - Copy' ),
			8  => __( 'Envira gallery submitted.', 'envira-gallery-lite - Copy' ),
			/* translators: %s: scheduled date */
			9  => sprintf( __( 'Envira gallery scheduled for: <strong>%1$s</strong>.', 'envira-gallery-lite - Copy' ), date_i18n( __( 'M j, Y @ G:i' ), strtotime( $post->post_date ) ) ),
			10 => __( 'Envira gallery draft updated.', 'envira-gallery-lite - Copy' ),
		);
