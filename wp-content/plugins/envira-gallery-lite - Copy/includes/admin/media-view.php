...
class Envira_Gallery_Media_View {
	...
	public function print_media_templates() {
				...
				<div class="attachments-browser envira-gallery envira-gallery-editor">
					...
					<div class="media-toolbar">
						...
						<div class="media-toolbar-primary search-form">
							<label for="envira-gallery-search" class="screen-reader-text"><?php esc_html_e( 'Search', 'envira-gallery-lite - Copy' ); ?></label>
							<input type="search" placeholder="<?php esc_attr_e( 'Search', 'envira-gallery-lite - Copy' ); ?>" id="envira-gallery-search" class="search" />
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/html" id="tmpl-envira-selection-sidebar">
			<!-- Helpful Tips -->
			<h3><?php esc_html_e( 'Helpful Tips', 'envira-gallery-lite - Copy' ); ?></h3>
			<strong><?php esc_html_e( 'Choosing Your Gallery', 'envira-gallery-lite - Copy' ); ?></strong>
			<p>
				<?php esc_html_e( 'To choose your gallery, simply click on one of the boxes to the left. Ctrl / cmd and click to select multiple Galleries.  The "Insert Gallery" button will be activated once you have selected a gallery.', 'envira-gallery-lite - Copy' ); ?>
			</p>
			<strong><?php esc_html_e( 'Inserting Your Gallery', 'envira-gallery-lite - Copy' ); ?></strong>
			<p>
				<?php esc_html_e( 'insert your gallery into the editor, click on the "Insert Gallery" button below.', 'envira-gallery-lite - Copy' ); ?>
			</p>

			<!-- Insert Options -->
			<h3><?php esc_html_e( 'Insert Options', 'envira-gallery-lite - Copy' ); ?></h3>
			<div class="settings">
				<!-- Display Title -->
				<label class="setting">
					<span class="name"><?php esc_html_e( 'Display Title', 'envira-gallery-lite - Copy' ); ?></span>
					<select name="title" size="1">
						<option value="0" selected><?php esc_html_e( 'No', 'envira-gallery-lite - Copy' ); ?></option>
						<?php
						for ( $i = 1; $i <= 6; $i++ ) {
							?>
							<?php /* translators: %s: heading size integer*/ ?>
							<option value="h<?php echo intval( $i ); ?>"><?php echo sprintf( esc_html__( 'Yes, as Heading H%s', 'envira-gallery-lite - Copy' ), intval( $i ) ); ?></option>
							<?php
						}
						?>
					</select>
				...
				<p class="description">
					<?php esc_html_e( 'Prepends each inserted Gallery with the Gallery Title.', 'envira-gallery-lite - Copy' ); ?>
				</p>
			</div>
		</script>
		...
		<script type="text/html" id="tmpl-envira-meta-editor">
			...
			<div class="media-frame-title">
				<h1><?php esc_html_e( 'Edit Metadata', 'envira-gallery-lite - Copy' ); ?></h1>
			</div>
			<div class="media-frame-content">
				<div class="attachment-details save-ready">
					...
					<div class="attachment-info">
						...
						<div class="settings">
							...
							<!-- Image Title -->
							<label class="setting">
								<span class="name"><?php esc_html_e( 'Title', 'envira-gallery-lite - Copy' ); ?></span>
								<input type="text" name="title" value="{{ data.title }}" />
								<div class="description">
									<?php esc_html_e( 'Image titles can take any type of HTML. You can adjust the position of the titles in the main Lightbox settings.', 'envira-gallery-lite - Copy' ); ?>
								</div>
							</label>
							...
							<!-- Alt Text -->
							<label class="setting">
								<span class="name"><?php esc_html_e( 'Alt Text', 'envira-gallery-lite - Copy' ); ?></span>
								<input type="text" name="alt" value="{{ data.alt }}" />
								<div class="description">
									<?php esc_html_e( 'Very important for SEO, the Alt Text describes the image.', 'envira-gallery-lite - Copy' ); ?>
								</div>
							</label>

							<!-- Link -->
							<label class="setting">
								<span class="name"><?php esc_html_e( 'URL', 'envira-gallery-lite - Copy' ); ?></span>
								<input type="text" name="link" value="{{ data.link }}" />
								<# if ( typeof( data.id ) === 'number' ) { #>
									<span class="buttons">
										<button class="button button-small media-file"><?php esc_html_e( 'Media File', 'envira-gallery-lite - Copy' ); ?></button>
										<button class="button button-small attachment-page"><?php esc_html_e( 'Attachment Page', 'envira-gallery-lite - Copy' ); ?></button>
									</span>
								<# } #>
								<span class="description">
									<?php esc_html_e( 'Enter a hyperlink if you wish to link this image to somewhere other than its full size image.', 'envira-gallery-lite - Copy' ); ?>
								</span>
							</label>

							<!-- Link in New Window -->
							<label class="setting">
								<span class="name"><?php esc_html_e( 'Open URL in New Window?', 'envira-gallery-lite - Copy' ); ?></span>
								<span class="description">
									<input type="checkbox" name="link_new_window" value="1"<# if ( data.link_new_window == '1' ) { #> checked <# } #> />
									<?php esc_html_e( 'Opens your image links in a new browser window / tab.', 'envira-gallery-lite - Copy' ); ?>
								</span>
							</label>
						...
						<!-- Actions -->
						<div class="actions">
							<a href="#" class="envira-gallery-meta-submit button media-button button-large button-primary media-button-insert" title="<?php esc_attr_e( 'Save Metadata', 'envira-gallery-lite - Copy' ); ?>">
								<?php esc_html_e( 'Save Metadata', 'envira-gallery-lite - Copy' ); ?>
							</a>

							<!-- Save Spinner -->
							<span class="settings-save-status">
								<span class="spinner"></span>
								<span class="saved"><?php esc_html_e( 'Saved.', 'envira-gallery-lite - Copy' ); ?></span>
							</span>
						</div>
						<!-- /.actions -->
					</div>
		...
		<script type="text/html" id="tmpl-envira-meta-bulk-editor">
			<div class="media-frame-title">
				<h1><?php esc_html_e( 'Bulk Edit', 'envira-gallery-lite - Copy' ); ?></h1>
			</div>
			<div class="media-frame-content">
				<div class="attachment-details save-ready">
					<!-- Left -->
					...
					<div class="attachment-info">
						...
						<div class="settings">
							...
							<!-- Caption -->
							<div class="setting">
								<span class="name"><?php esc_html_e( 'Caption', 'envira-gallery-lite - Copy' ); ?></span>
								<?php
								wp_editor(
									'',
									'caption',
								...
								?>
								<div class="description">
									<?php esc_html_e( 'Captions can take any type of HTML, and are displayed when an image is clicked.', 'envira-gallery-lite - Copy' ); ?>
								</div>
							</div>
						...
						<!-- Actions -->
						<div class="actions">
							<a href="#" class="envira-gallery-meta-submit button media-button button-large button-primary media-button-insert" title="<?php esc_attr_e( 'Save Metadata to Items', 'envira-gallery-lite - Copy' ); ?>">
								<?php esc_html_e( 'Save Metadata', 'envira-gallery-lite - Copy' ); ?>
							</a>
		...
		<script type="text/html" id="tmpl-envira-meta-move-media-sidebar">
			...
			<h3><?php esc_html_e( 'Helpful Tips', 'envira-gallery-lite - Copy' ); ?></h3>
			<p>
				<?php esc_html_e( 'Select the Gallery to move the selected images to by clicking on one of the boxes to the left.', 'envira-gallery-lite - Copy' ); ?>
			</p>
			<p>
				<?php esc_html_e( 'Once done, click the Move button, and the selected images will be moved to the chosen Gallery.', 'envira-gallery-lite - Copy' ); ?>
			</p>
		</script>
