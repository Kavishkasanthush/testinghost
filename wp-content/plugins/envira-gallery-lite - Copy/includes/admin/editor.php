...
class Envira_Gallery_Editor {
	...
	public function media_button( $buttons ) {
		...
		$button = '<a id="envira-media-modal-button" href="#" class="button envira-gallery-choose-gallery" data-action="gallery" title="' . esc_attr__( 'Add Gallery', 'envira-gallery-lite - Copy' ) . '" >
            <span class="envira-media-icon"></span> ' .
			esc_html__( 'Add Gallery', 'envira-gallery-lite - Copy' ) .
		'</a>';
