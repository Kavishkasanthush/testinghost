...
class Envira_Gallery_Common_Admin {
	...
	public function notice_galleries_migrated() {
		...
		<div class="notice updated">
			<p><strong><?php esc_html_e( 'Envira Gallery', 'envira-gallery-lite - Copy' ); ?>:&nbsp;</strong><?php esc_html_e( 'Your existing in-page Galleries can now be found by clicking on Envira Gallery in the WordPress Admin menu.', 'envira-gallery-lite - Copy' ); ?></p>
		</div>
		<?php
