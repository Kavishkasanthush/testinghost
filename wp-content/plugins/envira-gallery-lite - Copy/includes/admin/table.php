...
class Envira_Gallery_Table_Admin {
	...
	public function envira_columns( $columns ) {
		...
		$envira_columns = array(
			...
			'image'     => '',
			'title'     => __( 'Title', 'envira-gallery-lite - Copy' ),
			'shortcode' => __( 'Shortcode', 'envira-gallery-lite - Copy' ),
			'posts'     => __( 'Posts', 'envira-gallery-lite - Copy' ),
			'modified'  => __( 'Last Modified', 'envira-gallery-lite - Copy' ),
			'date'      => __( 'Date', 'envira-gallery-lite - Copy' ),
		);
			...
			*/
			case 'image':
				...
				if ( ! empty( $gallery_data['gallery'] ) && is_array( $gallery_data['gallery'] ) ) {
					...
					printf( esc_html( _n( '%d Image', '%d Images', count( $gallery_data['gallery'] ), 'envira-gallery-lite - Copy' ) ), count( $gallery_data['gallery'] ) );
				}
				break;
			...
			*/
			case 'shortcode':
                ...
                <div class="envira-code">
                    ...
                    <a href="#" title="' . esc_html__( 'Copy Shortcode to Clipboard', 'envira-gallery-lite - Copy' ) . '" data-clipboard-target="#envira_shortcode_' . intval( $post_id ) . '" class="dashicons dashicons-clipboard envira-clipboard">
                        <span>' . esc_html__( 'Copy to Clipboard', 'envira-gallery-lite - Copy' ) . '</span>
                    </a>
                </div>';
				...
				<fieldset class="inline-edit-col-left inline-edit-envira-gallery">
					<div class="inline-edit-col inline-edit-<?php echo esc_attr( $column_name ); ?>">
						<label class="inline-edit-group">
							<span class="title"><?php esc_html_e( 'Number of Columns', 'envira-gallery-lite - Copy' ); ?></span>
						...
						<label class="inline-edit-group">
							<span class="title"><?php esc_html_e( 'Gallery Theme', 'envira-gallery-lite - Copy' ); ?></span>
				...
				<fieldset class="inline-edit-col-left inline-edit-envira-gallery">
					<div class="inline-edit-col inline-edit-<?php echo esc_attr( $column_name ); ?>">
						<label class="inline-edit-group">
							<span class="title"><?php esc_html_e( 'Number of Columns', 'envira-gallery-lite - Copy' ); ?></span>
							<select name="_envira_gallery[columns]">
								<option value="-1" selected><?php esc_html_e( '— No Change —', 'envira-gallery-lite - Copy' ); ?></option>
