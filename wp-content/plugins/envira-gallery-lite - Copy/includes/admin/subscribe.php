...
class Envira_Subscribe {
	...
	public function subscribe() {
		...
		if ( 'envira' !== $screen->post_type || 'envira_page_envira-gallery-lite - Copy-litevspro' === $screen->id ) {
			return;
		}
		...
		<div class="notice notice-info is-dismissible envira-subscribe-notice">
			<div id="envira-subscribe-block">
				<div id="envira-subscribe-error"><p><strong><?php esc_html_e( 'Opps, Looks like something went wrong.', 'envira-gallery-lite - Copy' ); ?></strong></p></div>
				<h2><?php esc_html_e( 'Thank you for using Envira Gallery.', 'envira-gallery-lite - Copy' ); ?></h2>
				<p><strong><?php esc_html_e( 'Get Envira updates, photography tips, tutorials and resources straight to your mailbox.', 'envira-gallery-lite - Copy' ); ?></strong></p>
				<p>
			...
			<div id="envira-subscribe-success">
				<p><strong><?php esc_html_e( 'Thank you for subscribing to Envira Gallery', 'envira-gallery-lite - Copy' ); ?></strong></p>
			</div>
		</div>
