...
class Envira_Gallery_Metaboxes {
	...
	public function notice_missing_extensions() {
		...
		?>
		<div class="error">
			<p><strong><?php esc_html_e( 'The GD or Imagick libraries are not installed on your server. Envira Gallery requires at least one (preferably Imagick) in order to crop images and may not work properly without it. Please contact your webhost and ask them to compile GD or Imagick for your PHP install.', 'envira-gallery-lite - Copy' ); ?></strong></p>
		</div>
		<?php
	...
	public function media_view_strings( $strings ) {
		...
		$strings['insertIntoPost'] = __( 'Insert into Gallery', 'envira-gallery-lite - Copy' );
		$strings['inserting']      = __( 'Inserting...', 'envira-gallery-lite - Copy' );
	...
	public function append_media_upload_form() {
		...
		<a href="#" class="envira-media-library button" title="<?php esc_attr_e( 'Click Here to Insert from Other Image Sources', 'envira-gallery-lite - Copy' ); ?>" style="vertical-align: baseline;">
			<?php esc_html_e( 'Select Files from Other Sources', 'envira-gallery-lite - Copy' ); ?>
		</a>
		...
		<div class="envira-progress-bar">
			...
			<div class="envira-progress-bar-status">
				<span class="uploading">
					<?php esc_html_e( 'Uploading Image', 'envira-gallery-lite - Copy' ); ?>
					<span class="current">1</span>
					<?php esc_html_e( 'of', 'envira-gallery-lite - Copy' ); ?>
					<span class="total">3</span>
				</span>

				<span class="done"><?php esc_html_e( 'All images uploaded.', 'envira-gallery-lite - Copy' ); ?></span>
			</div>
		</div>

		<div class="envira-progress-adding-images">
			<div class="envira-progress-status">
				<span class="spinner"></span><span class="adding_images"><?php esc_html_e( 'Adding items to gallery.', 'envira-gallery-lite - Copy' ); ?></span>
			</div>
		</div>
		<?php
	...
	public function scripts( $hook ) {
		...
		wp_localize_script(
			...
			array(
				...
				'modal_title'         => __( 'Insert', 'envira-gallery-lite - Copy' ),
				'insert_button_label' => __( 'Insert', 'envira-gallery-lite - Copy' ),
			)
		);
		...
		wp_localize_script(
			...
			array(
				...
				'id'                             => $post_id,
				'import'                         => __( 'You must select a file to import before continuing.', 'envira-gallery-lite - Copy' ),
				'insert_nonce'                   => wp_create_nonce( 'envira-gallery-insert-images' ),
				'inserting'                      => __( 'Inserting...', 'envira-gallery-lite - Copy' ),
				...
				'move_media_modal_title'         => __( 'Move Media to Gallery', 'envira-gallery-lite - Copy' ),
				'move_media_insert_button_label' => __( 'Move Media to Selected Gallery', 'envira-gallery-lite - Copy' ),
				'preview_nonce'                  => wp_create_nonce( 'envira-gallery-change-preview' ),
				'refresh_nonce'                  => wp_create_nonce( 'envira-gallery-refresh' ),
				'remove'                         => __( 'Are you sure you want to remove this image from the gallery?', 'envira-gallery-lite - Copy' ),
				'remove_multiple'                => __( 'Are you sure you want to remove these images from the gallery?', 'envira-gallery-lite - Copy' ),
				...
				'saving'                         => __( 'Saving...', 'envira-gallery-lite - Copy' ),
				'saved'                          => __( 'Saved!', 'envira-gallery-lite - Copy' ),
				'sort'                           => wp_create_nonce( 'envira-gallery-sort' ),
				'uploader_files_computer'        => __( 'Select Files from Your Computer', 'envira-gallery-lite - Copy' ),
			)
		);
	...
	public function add_meta_boxes() {
		...
		if ( ! in_array( $type, array( 'defaults', 'dynamic' ), true ) ) {
			add_meta_box( 'envira-gallery', __( 'Envira Gallery', 'envira-gallery-lite - Copy' ), array( $this, 'meta_box_gallery_callback' ), 'envira', 'normal', 'high' );
		}

		// Settings Metabox.
		add_meta_box( 'envira-gallery-settings', __( 'Envira Gallery Settings', 'envira-gallery-lite - Copy' ), array( $this, 'meta_box_callback' ), 'envira', 'normal', 'high' );

		// Display the Gallery Code metabox if we're editing an existing Gallery.
		if ( 'auto-draft' !== $post->post_status ) {
			add_meta_box( 'envira-gallery-code', __( 'Envira Gallery Code', 'envira-gallery-lite - Copy' ), array( $this, 'meta_box_gallery_code_callback' ), 'envira', 'side', 'default' );
		}
	...
	public function get_envira_types( $post ) {
		...
		$types = array(
			'default' => __( 'Default', 'envira-gallery-lite - Copy' ),
		);
	...
	public function get_envira_tab_nav() {
		...
		$tabs = array(
			'images'   => __( 'Gallery', 'envira-gallery-lite - Copy' ),
			'config'   => __( 'Config', 'envira-gallery-lite - Copy' ),
			'lightbox' => __( 'Lightbox', 'envira-gallery-lite - Copy' ),
			'mobile'   => __( 'Mobile', 'envira-gallery-lite - Copy' ),
		);

		$tabs = apply_filters( 'envira_gallery_tab_nav', $tabs );

		// "Misc" tab is required.
		$tabs['misc'] = __( 'Misc', 'envira-gallery-lite - Copy' );
	...
	public function do_default_display( $post ) {
		...
		<p class="envira-intro">
			<?php esc_html_e( 'Currently in your Gallery', 'envira-gallery-lite - Copy' ); ?>
			<small>
				<?php esc_html_e( 'Need some help?', 'envira-gallery-lite - Copy' ); ?>
				<a href="<?php echo esc_url( $upgrade_link ); ?>" class="envira-doc" target="_blank">
					<?php esc_html_e( 'Read the Documentation', 'envira-gallery-lite - Copy' ); ?>
				</a>
				<?php esc_html_e( 'or', 'envira-gallery-lite - Copy' ); ?>
				<a href="https://www.youtube.com/embed/F9_wOefuBaw?autoplay=1&amp;rel=0" class="envira-video" target="_blank">
					<?php esc_html_e( 'Watch a Video', 'envira-gallery-lite - Copy' ); ?>
				</a>
			</small>
		</p>
		...
		Envira_Gallery_Notice_Admin::get_instance()->display_inline_notice(
			...
			__( 'Want to make your gallery workflow and presentation even better?', 'envira-gallery-lite - Copy' ),
			...
			'warning',
			__( 'Click here to Upgrade', 'envira-gallery-lite - Copy' ),
	...
	public function config_tab( $post ) {
		...
		<div id="envira-config">
			<!-- Title and Help -->
			<p class="envira-intro">
				<?php esc_html_e( 'Gallery Settings', 'envira-gallery-lite - Copy' ); ?>
				<small>
					<?php esc_html_e( 'The settings below adjust the basic configuration options for the gallery.', 'envira-gallery-lite - Copy' ); ?><br />
					<?php esc_html_e( 'Need some help?', 'envira-gallery-lite - Copy' ); ?>
					<a href="<?php echo esc_url( $upgrade_link ); ?>" class="envira-doc" target="_blank">
						<?php esc_html_e( 'Read the Documentation', 'envira-gallery-lite - Copy' ); ?>
					</a>
			...
			<table class="form-table" style="margin-bottom: 0;">
				<tbody>
					<tr id="envira-config-columns-box">
						<th scope="row">
							<label for="envira-config-columns"><?php esc_html_e( 'Number of Gallery Columns', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							...
							<p class="description"><?php esc_html_e( 'Determines the number of columns in the gallery. Automatic will attempt to fill each row as much as possible before moving on to the next row.', 'envira-gallery-lite - Copy' ); ?></p>
						</td>
					</tr>
					...
					<tr id="envira-config-lazy-loading-box">
						<th scope="row">
							<label for="envira-config-lazy-loading"><?php esc_html_e( 'Enable Lazy Loading?', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							...
							<span class="description"><?php esc_html_e( 'Enables or disables lazy loading, which helps with performance by loading thumbnails only when they are visible. See our documentation for more information.', 'envira-gallery-lite - Copy' ); ?></span>
						</td>
					</tr>
					...
					<tr id="envira-config-lazy-loading-delay">
						<th scope="row">
							<label for="envira-config-lazy-loading-delay"><?php esc_html_e( 'Lazy Loading Delay', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
							<td>
								<input id="envira-config-lazy-loading-delay" type="number" name="_envira_gallery[lazy_loading_delay]" value="<?php echo esc_attr( $this->get_config( 'lazy_loading_delay', $this->get_config_default( 'lazy_loading_delay' ) ) ); ?>" /> <span class="envira-unit"><?php esc_html_e( 'milliseconds', 'envira-gallery-lite - Copy' ); ?></span>
								<p class="description"><?php esc_html_e( 'Set a delay when new images are loaded', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
					</tr>
				</tbody>
			</table>
				...
				<table class="form-table" style="margin-bottom: 0;">
					<tbody>
						<tr id="envira-config-justified-row-height">
							<th scope="row">
								<label for="envira-config-justified-row-height"><?php esc_html_e( 'Automatic Layout: Row Height', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								<input id="envira-config-justified-row-height" type="number" name="_envira_gallery[justified_row_height]" value="<?php echo esc_attr( $this->get_config( 'justified_row_height', $this->get_config_default( 'justified_row_height' ) ) ); ?>" /> <span class="envira-unit"><?php esc_html_e( 'px', 'envira-gallery-lite - Copy' ); ?></span>
								<p class="description"><?php esc_html_e( 'Determines how high (in pixels) each row will be. 150px is default. ', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-justified-margins">
							<th scope="row">
								<label for="envira-config-justified-margins"><?php esc_html_e( 'Automatic Layout: Margins', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								<input id="envira-config-justified-margins" type="number" name="_envira_gallery[justified_margins]" value="<?php echo esc_attr( $this->get_config( 'justified_margins', $this->get_config_default( 'justified_margins' ) ) ); ?>" /> <span class="envira-unit"><?php esc_html_e( 'px', 'envira-gallery-lite - Copy' ); ?></span>
								<p class="description"><?php esc_html_e( 'Sets the space between the images (defaults to 1)', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="form-table">
					<tbody>
						...
						<tr id="envira-config-gallery-theme-box">
							<th scope="row">
								<label for="envira-config-gallery-theme"><?php esc_html_e( 'Gallery Theme', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Sets the theme for the gallery display.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-gutter-box">
							<th scope="row">
								<label for="envira-config-gutter"><?php esc_html_e( 'Column Gutter Width', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								<input id="envira-config-gutter" type="number" name="_envira_gallery[gutter]" value="<?php echo esc_attr( $this->get_config( 'gutter', $this->get_config_default( 'gutter' ) ) ); ?>" /> <span class="envira-unit"><?php esc_html_e( 'px', 'envira-gallery-lite - Copy' ); ?></span>
								<p class="description"><?php esc_html_e( 'Sets the space between the columns (defaults to 10).', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-margin-box">
							<th scope="row">
								<label for="envira-config-margin"><?php esc_html_e( 'Margin Below Each Image', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								<input id="envira-config-margin" type="number" name="_envira_gallery[margin]" value="<?php echo esc_attr( $this->get_config( 'margin', $this->get_config_default( 'margin' ) ) ); ?>" /> <span class="envira-unit"><?php esc_html_e( 'px', 'envira-gallery-lite - Copy' ); ?></span>
								<p class="description"><?php esc_html_e( 'Sets the space below each item in the gallery.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
				...
				<table class="form-table">
					<tbody>
						...
						<tr id="envira-config-image-size-box">
							<th scope="row">
								<label for="envira-config-image-size"><?php esc_html_e( 'Image Size', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Define the maximum image size for the Gallery view. Default will use the below Image Dimensions; Random will allow you to choose one or more WordPress image sizes, which will be used for the gallery output.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-crop-size-box">
							<th scope="row">
								<label for="envira-config-crop-width"><?php esc_html_e( 'Image Dimensions', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								<input id="envira-config-crop-width" type="number" name="_envira_gallery[crop_width]" value="<?php echo esc_attr( $this->get_config( 'crop_width', $this->get_config_default( 'crop_width' ) ) ); ?>" /> &#215; <input id="envira-config-crop-height" type="number" name="_envira_gallery[crop_height]" value="<?php echo esc_attr( $this->get_config( 'crop_height', $this->get_config_default( 'crop_height' ) ) ); ?>" /> <span class="envira-unit"><?php esc_html_e( 'px', 'envira-gallery-lite - Copy' ); ?></span>
								<p class="description"><?php esc_html_e( 'You should adjust these dimensions based on the number of columns in your gallery. This does not affect the full size lightbox images.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-crop-box">
							<th scope="row">
								<label for="envira-config-crop"><?php esc_html_e( 'Crop Images?', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								...
								<span class="description"><?php esc_html_e( 'If enabled, forces images to exactly match the sizes defined above for Image Dimensions and Mobile Dimensions.', 'envira-gallery-lite - Copy' ); ?></span>
								<span class="description"><?php esc_html_e( 'If disabled, images will be resized to maintain their aspect ratio.', 'envira-gallery-lite - Copy' ); ?></span>
		...
		Envira_Gallery_Notice_Admin::get_instance()->display_inline_notice(
			...
			'warning',
			__( 'Click here to Upgrade Today', 'envira-gallery-lite - Copy' ),
	...
	public function lightbox_tab( $post ) {
		...
		<div id="envira-lightbox">
			<p class="envira-intro">
				<?php esc_html_e( 'Lightbox Settings', 'envira-gallery-lite - Copy' ); ?>
				<small>
					<?php esc_html_e( 'The settings below adjust the lightbox output.', 'envira-gallery-lite - Copy' ); ?>
					<br />
					<?php esc_html_e( 'Need some help?', 'envira-gallery-lite - Copy' ); ?>
					<a href="<?php echo esc_url( $upgrade_link ); ?>" class="envira-doc" target="_blank">
						<?php esc_html_e( 'Read the Documentation', 'envira-gallery-lite - Copy' ); ?>
			...
			<table class="form-table no-margin">
				<tbody>
					<tr id="envira-config-lightbox-enabled-box">
						<th scope="row">
							<label for="envira-config-lightbox-enabled"><?php esc_html_e( 'Enable Lightbox?', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							...
							<span class="description"><?php esc_html_e( 'Enables or disables the gallery lightbox.', 'envira-gallery-lite - Copy' ); ?></span>
						</td>
					</tr>
				...
				<table class="form-table">
					<tbody>
						<tr id="envira-config-lightbox-theme-box">
							<th scope="row">
								<label for="envira-config-lightbox-theme"><?php esc_html_e( 'Gallery Lightbox Theme', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Sets the theme for the gallery lightbox display.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-lightbox-image-size-box">
							<th scope="row">
								<label for="envira-config-lightbox-image-size"><?php esc_html_e( 'Image Size', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Define the maximum image size for the Lightbox view. Default will display the original, full size image.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
						<tr id="envira-config-lightbox-title-display-box">
							<th scope="row">
								<label for="envira-config-lightbox-title-display"><?php esc_html_e( 'Caption Position', 'envira-gallery-lite - Copy' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Sets the display of the lightbox image\'s caption.', 'envira-gallery-lite - Copy' ); ?></p>
							</td>
						</tr>
		...
		Envira_Gallery_Notice_Admin::get_instance()->display_inline_notice(
			'envira_gallery_images_tab',
			__( 'Want even more fine tuned control over your lightbox display?', 'envira-gallery-lite - Copy' ),
	...
	public function misc_tab( $post ) {
		...
		<div id="envira-misc">
			<p class="envira-intro">
				<?php esc_html_e( 'Miscellaneous Settings', 'envira-gallery-lite - Copy' ); ?>
				<small>
					<?php esc_html_e( 'The settings below adjust miscellaneous options for the Gallery.', 'envira-gallery-lite - Copy' ); ?>
					<br />
					<?php esc_html_e( 'Need some help?', 'envira-gallery-lite - Copy' ); ?>
					<a href="<?php echo esc_url( $upgrade_link ); ?>" class="envira-doc" target="_blank">
						<?php esc_html_e( 'Read the Documentation', 'envira-gallery-lite - Copy' ); ?>
			...
			<table class="form-table">
				<tbody>
					<tr id="envira-config-title-box">
						<th scope="row">
							<label for="envira-config-title"><?php esc_html_e( 'Gallery Title', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							...
							<p class="description"><?php esc_html_e( 'Internal gallery title for identification in the admin.', 'envira-gallery-lite - Copy' ); ?></p>
						</td>
					</tr>
					<tr id="envira-config-slug-box">
						<th scope="row">
							<label for="envira-config-slug"><?php esc_html_e( 'Gallery Slug', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							...
							<p class="description"><?php esc_html_e( '<strong>Unique</strong> internal gallery slug for identification and advanced gallery queries.', 'envira-gallery-lite - Copy' ); ?></p>
						</td>
					</tr>
					<tr id="envira-config-classes-box">
						<th scope="row">
							<label for="envira-config-classes"><?php esc_html_e( 'Custom Gallery Classes', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							<?php
					...
					<tr id="envira-config-rtl-box">
						<th scope="row">
							<label for="envira-config-rtl"><?php esc_html_e( 'Enable RTL Support?', 'envira-gallery-lite - Copy' ); ?></label>
						</th>
						<td>
							...
							<span class="description"><?php esc_html_e( 'Enables or disables RTL support in Envira for right-to-left languages.', 'envira-gallery-lite - Copy' ); ?></span>
						</td>
					</tr>
		...
		Envira_Gallery_Notice_Admin::get_instance()->display_inline_notice(
			'envira_gallery_images_tab',
			__( 'Want to take your galleries further?', 'envira-gallery-lite - Copy' ),
	...
	public function lite_tabs( $tabs ) {
		...
		$tabs['mobile']     = __( 'Mobile', 'envira-gallery-lite - Copy' );
		$tabs['videos']     = __( 'Videos', 'envira-gallery-lite - Copy' );
		$tabs['social']     = __( 'Social', 'envira-gallery-lite - Copy' );
		$tabs['tags']       = __( 'Tags', 'envira-gallery-lite - Copy' );
		$tabs['pagination'] = __( 'Pagination', 'envira-gallery-lite - Copy' );
		return $tabs;
	...
	<li id="<?php echo esc_attr( $id ); ?>" class="envira-gallery-image envira-gallery-status-<?php echo esc_attr( $item['status'] ); ?>" data-envira-gallery-image="<?php echo esc_attr( $id ); ?>" data-envira-gallery-image-model='<?php echo esc_html( htmlspecialchars( $json, ENT_QUOTES, 'UTF-8' ) ); ?>'>
		...
		<a href="#" class="dashicons dashicons-trash envira-gallery-remove-image" title="<?php esc_html_e( 'Remove Image from Gallery?', 'envira-gallery-lite - Copy' ); ?>"></a>
		<a href="#" class="dashicons dashicons-edit envira-gallery-modify-image" title="<?php esc_html_e( 'Modify Image', 'envira-gallery-lite - Copy' ); ?>"></a>
	</li>
		<?php
		return ob_get_clean();
