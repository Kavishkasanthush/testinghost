...
class Envira_Welcome {
	 ...
	 */
	public $pages = array(
		'envira-gallery-lite - Copy-get-started',
		'envira-gallery-lite - Copy-welcome',
		'envira-gallery-lite - Copy-partners',
		'envira-gallery-lite - Copy-upgrade',
		'envira-gallery-lite - Copy-litevspro',
	);
		...
		if ( isset( $_GET['post_type'] ) && isset( $_GET['page'] ) && 'envira' === wp_unslash( $_GET['post_type'] ) && in_array( wp_unslash( $_GET['page'] ), $this->pages ) ) { // @codingStandardsIgnoreLine
			...
			wp_localize_script(
				...
				array(
					...
					'active'           => __( 'Status: Active', 'envira-gallery-lite - Copy' ),
					'activate'         => __( 'Activate', 'envira-gallery-lite - Copy' ),
					'get_addons_nonce' => wp_create_nonce( 'envira-gallery-get-addons' ),
					'activating'       => __( 'Activating...', 'envira-gallery-lite - Copy' ),
					'ajax'             => admin_url( 'admin-ajax.php' ),
					'deactivate'       => __( 'Deactivate', 'envira-gallery-lite - Copy' ),
					'deactivate_nonce' => wp_create_nonce( 'envira-gallery-deactivate-partner' ),
					'deactivating'     => __( 'Deactivating...', 'envira-gallery-lite - Copy' ),
					'inactive'         => __( 'Status: Inactive', 'envira-gallery-lite - Copy' ),
					'install'          => __( 'Install', 'envira-gallery-lite - Copy' ),
					'install_nonce'    => wp_create_nonce( 'envira-gallery-install-partner' ),
					'installing'       => __( 'Installing...', 'envira-gallery-lite - Copy' ),
					'proceed'          => __( 'Proceed', 'envira-gallery-lite - Copy' ),
				)
			);
		}
	}
	...
	public function get_partners() {
		...
		$partners = array(
			...
			'envira-gallery-lite - Copy'   => array(
				'name'        => 'PDF Embedder',
	...
	public function admin_menu() {
		$whitelabel = apply_filters( 'envira_whitelabel', false ) ? '' : __( 'Envira Gallery ', 'envira-gallery-lite - Copy' );
		// Register the submenus.
		add_submenu_page(
			'edit.php?post_type=envira',
			$whitelabel . __( 'Get Started', 'envira-gallery-lite - Copy' ),
			'<span style="color:#FFA500"> ' . __( 'Get Started', 'envira-gallery-lite - Copy' ) . '</span>',
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			$whitelabel . __( 'Upgrade Envira Gallery', 'envira-gallery-lite - Copy' ),
			'<span style="color:#FFA500"> ' . __( 'Upgrade Envira Gallery', 'envira-gallery-lite - Copy' ) . '</span>',
			apply_filters( 'envira_gallery_menu_cap', 'manage_options' ),
			ENVIRA_SLUG . '-upgrade',
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			$whitelabel . __( 'Lite vs Pro', 'envira-gallery-lite - Copy' ),
			'<span style="color:#FFA500"> ' . __( 'Lite vs Pro', 'envira-gallery-lite - Copy' ) . '</span>',
			apply_filters( 'envira_gallery_menu_cap', 'manage_options' ),
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			$whitelabel . __( 'Welcome', 'envira-gallery-lite - Copy' ),
			'<span style="color:#FFA500"> ' . __( 'Welcome', 'envira-gallery-lite - Copy' ) . '</span>',
			apply_filters( 'envira_gallery_menu_cap', 'manage_options' ),
			ENVIRA_SLUG . '-welcome',
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			$whitelabel . __( 'Partners', 'envira-gallery-lite - Copy' ),
			'<span style="color:#FFA500"> ' . __( 'Partners', 'envira-gallery-lite - Copy' ) . '</span>',
			apply_filters( 'envira_gallery_menu_cap', 'manage_options' ),
	...
	public static function welcome_text() {
		...
		$welcome_text = ( self::is_new_install() )
			? esc_html__( 'Thank you for installing Envira Lite! Envira provides great gallery features for your WordPress site!', 'envira-gallery-lite - Copy' )
			: esc_html__( 'Thank you for updating! Envira Lite has many recent improvements that you will enjoy.', 'envira-gallery-lite - Copy' );

		?>
		<?php /* translators: %s: version */ ?>
		<h1 class="welcome-header"><?php printf( esc_html__( 'Welcome to %1$s Envira Gallery Lite %2$s', 'envira-gallery-lite - Copy' ), '<span class="envira-leaf"></span>&nbsp;', esc_html( self::display_version() ) ); ?></h1>
	...
	public static function tab_navigation( $tab = 'whats_new' ) {
		...
		<h3 class="nav-tab-wrapper">
			<a class="nav-tab
			<?php
			if ( isset( $_GET['page'] ) && 'envira-gallery-lite - Copy-welcome' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) : // @codingStandardsIgnoreLine
				?>
				...
				echo esc_url(
					admin_url(
						add_query_arg(
							array(
								'post_type' => 'envira',
								'page'      => 'envira-gallery-lite - Copy-welcome',
							),
							'edit.php'
						)
					)
				...
				?>
														">
				<?php esc_html_e( 'What&#8217;s New', 'envira-gallery-lite - Copy' ); ?>
			</a>
			<a class="nav-tab
			<?php
			if ( isset( $_GET['page'] ) && 'envira-gallery-lite - Copy-get-started' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) : // @codingStandardsIgnoreLine
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
					admin_url(
						add_query_arg(
							array(
								'post_type' => 'envira',
								'page'      => 'envira-gallery-lite - Copy-get-started',
							),
							'edit.php'
						)
					)
				...
				?>
														">
				<?php esc_html_e( 'Get Started', 'envira-gallery-lite - Copy' ); ?>
			</a>
			<a class="nav-tab
			<?php
			if ( isset( $_GET['page'] ) && 'envira-gallery-lite - Copy-litevspro' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) : // @codingStandardsIgnoreLine
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
					admin_url(
						add_query_arg(
							array(
								'post_type' => 'envira',
								'page'      => 'envira-gallery-lite - Copy-litevspro',
							),
							'edit.php'
						)
					)
				...
				?>
														">
				<?php esc_html_e( 'Lite vs Pro', 'envira-gallery-lite - Copy' ); ?>
			</a>
			<a class="nav-tab
			<?php
			if ( isset( $_GET['page'] ) && 'envira-gallery-lite - Copy-upgrade' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) : // @codingStandardsIgnoreLine
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
					admin_url(
						add_query_arg(
							array(
								'post_type' => 'envira',
								'page'      => 'envira-gallery-lite - Copy-upgrade',
							),
							'edit.php'
						)
					)
				...
				?>
														">
				<?php esc_html_e( 'Unlock Pro', 'envira-gallery-lite - Copy' ); ?>
			</a>
			<a class="nav-tab
			<?php
			if ( isset( $_GET['page'] ) && 'envira-gallery-lite - Copy-partners' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) : // @codingStandardsIgnoreLine
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
					admin_url(
						add_query_arg(
							array(
								'post_type' => 'envira',
								'page'      => 'envira-gallery-lite - Copy-partners',
							),
							'edit.php'
						)
					)
				...
				?>
														">
				<?php esc_html_e( 'Partners', 'envira-gallery-lite - Copy' ); ?>
			</a>
		</h3>
		...
		<div class="envira-welcome-wrap envira-welcome">
				...
				<div class="envira-welcome-main">
					...
					<h2 class="headline-title">
						...
						printf( esc_html__( 'Welcome to Envira Gallery Lite %1$s', 'envira-gallery-lite - Copy' ), esc_html( self::display_version() ) );
						?>
					</h2>

					<h4 class="headline-subtitle"><?php esc_html_e( 'Envira Gallery is the most beginner-friendly drag &amp; drop WordPress gallery plugin.', 'envira-gallery-lite - Copy' ); ?></h2>
				</div>
						<div class="wraps about-wsrap">

							<div class="envira-panel envira-lite-updates-panel">
								<h3 class="title"><?php esc_html_e( 'Recent Updates To Envira Lite:', 'envira-gallery-lite - Copy' ); ?></h3>

								<div class="envira-recent envirathree-column">
									<div class="enviracolumn">
											<h4 class="title"><?php esc_html_e( 'Bug Fixes', 'envira-gallery-lite - Copy' ); ?> <span class="badge updated">UPDATED</span></h4>
									...
									<div class="enviracolumn">
											<h4 class="title"><?php esc_html_e( 'Gutenberg Block', 'envira-gallery-lite - Copy' ); ?></h4>
											<?php /* translators: %1$s: link */ ?>
									...
									<div class="enviracolumn">
											<h4 class="title"><?php esc_html_e( 'Enhancements', 'envira-gallery-lite - Copy' ); ?></h4>
											<p><?php printf( esc_html__( 'Ability to set margins for Automatic Layouts. Also better workings with various popular WordPress plugins and themes.', 'envira-gallery-lite - Copy' ) ); ?></p>
									</div>
								</div>
							...
							<div class="envira-panel envira-pro-updates-panel">
								...
								<div class="envira-feature opposite">
									...
									<h4 class="feature-title">
										<?php esc_html_e( 'Proofing Addon', 'envira-gallery-lite - Copy' ); ?>
									</h4>
									<p>
										<?php /* translators: %1$s: url, %2$s url */ ?>
										<?php printf( esc_html__( 'New and improved features and functions make client image proofing even easier for your photography business.', 'envira-gallery-lite - Copy' ) ); ?>
										</p>
								</div>

								<div class="envira-feature">
								<img class="icon" src="<?php echo esc_url( plugins_url( 'assets/images/icons/automatic-layout.png', ENVIRA_FILE ) ); ?>" />
								<h4 class="feature-title"><?php esc_html_e( 'Gallery Layouts', 'envira-gallery-lite - Copy' ); ?> <span class="badge updated">NEW</span> </h4>
								...
								<h4 class="feature-title"><?php esc_html_e( 'Audio Addon', 'envira-gallery-lite - Copy' ); ?> <span class="badge updated">NEW</span> </h4>
								<?php /* translators: %1$s: button */ ?>
								<p><?php printf( esc_html__( 'This addon allows you to easily add an audio track (such as background music or a narration) to the lightboxes in your Envira galleries. %s', 'envira-gallery-lite - Copy' ), '<a target="_blank" href="' . esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/addons/audio-addon/', 'whatsnewtab', 'audioaddonreadmore', '' ) . '">Read More</a>' ) ); ?></p>
								</div>
								</div>
							</div>
			...
			<div class="envira-get-started-main">
				...
				<div class="envira-get-started-panel">
					...
					<div class="wraps upgrade-wrap">
						...
						<h2 class="headline-title"><?php esc_html_e( 'Make Your Galleries Amazing!', 'envira-gallery-lite - Copy' ); ?></h2>

						<h4 class="headline-subtitle"><?php esc_html_e( 'Upgrade To Envira Pro and can get access to our full suite of features.', 'envira-gallery-lite - Copy' ); ?></h4>
			...
			<div class="envira-get-started-main">
				...
				<div class="envira-get-started-panel">
					...
					<div class="wraps upgrade-wrap">
						...
						<h2 class="headline-title"><?php esc_html_e( 'See Our Partners!', 'envira-gallery-lite - Copy' ); ?></h2>

						<h4 class="headline-subtitle"><?php esc_html_e( 'We have partnered with these amazing companies for further enhancement to your Envira Gallery experience.', 'envira-gallery-lite - Copy' ); ?></h4>
