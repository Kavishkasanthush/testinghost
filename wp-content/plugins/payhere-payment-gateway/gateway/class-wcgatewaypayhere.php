...
class WCGatewayPayHere extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->merchant_id      = isset($this->settings['merchant_id']) && !empty($this->settings['merchant_id']) ?  $this->settings['merchant_id'] : $this->settings['mechant_id']; //$this->settings['merchant_id'];
