<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes413_Metabox') ) {
		...
		abstract class Wbcr_FactoryMetaboxes413_Metabox {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_Factory458_ScriptList
			 */
			public $scripts;
			 ...
			 *
			 * @since 1.0.0
			 * @param Factory458_ScriptList $scripts A set of scripts to include.
			 * @param Factory458_StyleList $styles A set of style to include.
			 * @return void
			 */
