<?php
	...
	//add_action('factory_458_plugin_activation', 'FactoryTaxonomy000::activationHook');
	//add_action('factory_458_plugin_deactivation', 'FactoryTaxonomy000::deactivationHook');
