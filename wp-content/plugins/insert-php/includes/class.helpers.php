...
SCRIPT;
	...
	public static function get_factory_class() {
		return "factory-bootstrap-459 factory-fontawesome-000";
	}

	/**
	 * Wrapper for Wbcr_FactoryForms455_OptionsValueProvider object
	 *
	 * @param $plugin
	 *
	 * @return Wbcr_FactoryForms455_OptionsValueProvider
	 */
	public static function get_options_value_provider( $plugin ) {
		return new Wbcr_FactoryForms455_OptionsValueProvider( $plugin );
	}
	...
	public static function get_factory_form( $options, $plugin ) {
		return new Wbcr_FactoryForms455_Form( $options, $plugin );
	}
